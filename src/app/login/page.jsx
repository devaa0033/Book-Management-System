        ...
        <div className="md:w-3/5 md:pr-8 w-full">
          ...
          <form action="" className="mt-4">
            {['Email', 'Password'].map((label, idx) => (
              <div
                className="form-group flex flex-col md:flex-row items-start md:items-center text-black mb-4"
                key={idx}
              >
                ...
                <input
                  ...
                  className="w-full flex-1 rounded-full p-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black"
            ...
            <div className="flex justify-center mt-4">
              <button
                type="submit"
                className="bg-blue-800 text-white py-2 px-6 rounded-full"
                onClick={handleClick}
              >
                Sign in
              </button>
